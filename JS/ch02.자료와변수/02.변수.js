...
let x = 0,
  y = 0;
console.log(x++, ++y); // post-increment(조회 후 1 증가), pre-increment(조회 전 1 증가) // 조회=출력
console.log(x, y);
...
// 4. undefined 자료형
let c;
console.log(typeof abc, typeof c); // 선언하지 않은 변수, 값을 초기화하지 않은 변수 > undefined 출력
...
console.log(Boolean(0), Boolean(0.0), Boolean(""), Boolean(undefined)); // false, 이 경우를 제외하곤 true
